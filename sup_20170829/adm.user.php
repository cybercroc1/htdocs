...
if($status<>'sended_code') {
	...
	echo "<font color=red>ВНИМАНИЕ! СОХРАНЕНИЕ ПРИВИЛЕГИЙ ОТКЛЮЧЕНО НА ВРЕМЯ РАЗРАБОТКИ НОВОЙ ВЕРСИИ. Все изменения, ниже этой надписи сохранены не будут.</font><hr>";
