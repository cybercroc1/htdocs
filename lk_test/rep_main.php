...
form2div.loading=function(frm_id,div_id,clicked_button) {
	...
	div.innerHTML='<div style="text-align:center;margin:30px;"><img src="img/progress.gif"></img><br><a class="abort-href" href=\'javascript:form2div_abort("'+frm_id+'","'+div_id+'")\'>прервать загрузку</a></div>';	
}
