...
function showFormLink() {
	...
	<a href='' onclick='window.open(\"http://bt24.wilstream.ru/callcenter/form.php?aon=".$aon."\",\"bitwin\",\"location=no,width=350,height=600,top=100,left=100,toolbar=no,menubar=no,status=yes,resizable=yes,scrollbars=yes\");return false;'>
