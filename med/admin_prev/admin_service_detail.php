...
<head>
    ...
    <?php } ?>
    <title>Детализация услуги</title>
    <meta name="description" content="Детализация услуги">
</head>

<body style="margin-top: 0;">
<h3 style="margin-bottom: 0;margin-top: 0;">Список Детализации Услуг</h3>
...
<div>
    <form action="" method="post">
        ...
        ?>
        Новая Детализация: <input type="text" name="Name" style="width: 250px" placeholder="Детализация">
        </h3>
        <div>
