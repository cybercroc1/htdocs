...
if (isset($_POST['Name'])) {
    ...
    if ($count === 1) {
        echo "<p style='color: red'>Источник рекламы '".$_POST['Name']."' уже существует.<br /></p>";
    }
    else {
        $max_id++;
...
<div>
    <form action="" method="post">
        <h3>Новый Источник рекламы: <input type="text" name="Name" style="width: 250px" placeholder="Источник рекламы"></h3>
        <div>
