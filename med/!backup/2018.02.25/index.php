...
<?php } else { ?>
    ...
    <!--iframe src="< ?=PATH?>/main_menu.php" name="admMainTopFrame" id="admTopFrame" title="admTopFrame" width="100%" height="40" frameborder="yes" border="1" scrolling="no"> </iframe-->
    ...
    <?php if ($_SESSION['user_role'] == USER_ADMIN) { ?>
        <frameset COLS="25%,75%" id=admBottomFrame frameborder="YES" border="2">
            <!--iframe src="< ?=PATH?>/index-f.php" name="admLeftFrame" id="admLeftFrame" title="admLeftFrame" width="21%" height="600" frameborder="yes" border="1"> </iframe>
            <iframe name="admRightFrame" id="admRightFrame" title="admRightFrame" width="78%" height="600" frameborder="yes" border="1"> </iframe-->
