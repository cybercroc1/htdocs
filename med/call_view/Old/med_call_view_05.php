...
<script type="application/javascript">
    ...
    function open_edit(base_id, texnari_id, sid) {
        if (base_id > 0) {
            win = window.open("../med_call_out.php?base_id="+base_id+"&texnari_id="+texnari_id+"&sid="+sid, "med_call_"+base_id, "width=850, height=640, toolbar=no, scrollbars=yes, resizable=yes, status=yes");
            win.focus();
        }
    }
    function open_hist(sid) {
        ...
        if (null != phone_num) {
            win = window.open("../med_call_hist.php?phone_num="+phone_num+"&sid="+sid, "med_call_"+phone_num, "width=850, height=800, toolbar=no, scrollbars=yes, resizable=yes, status=yes");
            win.focus();
        }
    }
