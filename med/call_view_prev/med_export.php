...
<form action="export_xlsx.php" method="POST">
    ...
    <h2>Даты:&nbsp;
        с <input type="text" name="rep_start_date" id="rep_start_date" autocomplete="off" style="width: 7em;" value="<?= !empty($start_date) ? $start_date : '' ?>" />
        по <input type="text" name="rep_end_date" id="rep_end_date" autocomplete="off" style="width: 7em;" value="<?= !empty($end_date) ? $end_date : '' ?>"/>
        <?php
