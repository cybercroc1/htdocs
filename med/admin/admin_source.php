...
<head>
    ...
    <?php } ?>
    <title>Источники рекламы</title>
    <meta name="description" content="Источники рекламы">
</head>

<body style="margin-top: 0;">
<h3 style="margin-bottom: 0;margin-top: 0;">Список Источников рекламы</h3>
...
VALUES ( seq_source_man_id.nextval, '{$_POST['NameIst']}', 'Детализация', 3, '{$serv_list}' )";
        ...
        if ($query_result) {
			print "<script language='Javascript'>
				...
				<p style='color: green'>Новый источник рекламы успешно добавлен в таблицу. Идет перезагрузка данных...</p>";
        } else {
            echo "<p style='color: red'>Произошла ошибка добавления источника рекламы!</p>";
        }
    }
}
...
<div>
    <form action="" method="post">
        <h3>Новый Источник рекламы: <input type="text" name="NameIst" style="width: 250px" placeholder="Источник рекламы"><br>
            <?php if (GetData::GetServices(FALSE,FALSE,NULL) > 0) {
                ...
                echo "<option value='".SERVICE_ALL."' selected='selected'>Все услуги</option>";
                if (DB_OCI) {
