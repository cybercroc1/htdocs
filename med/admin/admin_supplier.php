...
$fields = array(
    "ID" => "", "SUP_NAME" => array("name" => "Название поставщика", "case"=>"sup.SUP_NAME"),
    "BALANCE" => array("name" => "Баланс"),
...
echo "<h3 style='margin: 5px;'>Баланс поставщиков</h3>";
...
echo "<input name='pay_visits' type='submit' value='Заплатить за визиты' style='font-weight: bold; background-color: green; color: wheat; height: 2em' />";
echo '</form>';
if (isset($pay_visits)) {
    pay_visits(FALSE);
