...
<form method='post' target='hidden_ifr'>
    <input type='text' name='server' value='<?=$_POST['array_user'][0]['SMTP_SERVER']?>' hidden/>
    <input type='text' name='port' value='<?=$_POST['array_user'][0]['SMTP_PORT']?>' hidden/>
    <input type='text' name='from_email' value='<?=$_POST['array_user'][0]['SMTP_FROM']?>' hidden/>
    <input type='text' name='from_name' value='<?=$_SESSION['login_name']?>' hidden/>
    <input type='text' name='auth_login' value='<?=$_POST['array_user'][0]['SMTP_LOGIN']?>' hidden/>
    <input type='text' name='auth_pass' value='<?=$_POST['array_user'][0]['SMTP_PASS']?>' hidden/><hr>
