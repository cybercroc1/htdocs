...
//это вариант авторизации инклудом к главной странице.
...
if (isset($exit)) { //если есть переменная exit, значит запрошен выход с сайта, подключаемся к сесии и дестроим ее
	...
	session_start(); //создает сесисю с именем и ложит ее в cookies, если на компьютере уже есть кукес с таким именем сесии, то подключается к существующей	
...
if(!isset($_SESSION['auth']) or $_SESSION['auth']<>'y') {//Пользователь не авторизован! показываем страницу логина и exit()
