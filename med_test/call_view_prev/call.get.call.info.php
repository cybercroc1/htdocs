...
to_char(cb.DATE_CLOSE,'dd.mm.yyyy hh24:mi:ss') as DATE_CLOSE, cb.LEAD_ID, cb.CALL_DOUBLE, cb.INTERSTATE, cb.OKTELL_IDCHAIN,
...
to_char(CLIENT_DATE,'dd.mm.yyyy hh24:mi') CLIENT_DATE FROM ".$table_name_cl." WHERE BASE_ID=:id");
            ...
            $base['idchain'] = OCIResult($q, "OKTELL_IDCHAIN");
        } else {
