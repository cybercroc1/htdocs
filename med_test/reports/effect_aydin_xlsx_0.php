...
if ($_SESSION['reports']['start_date'] != $_SESSION['reports']['end_date']) 
	...
	$period_text .='За ' . $_SESSION['reports']['start_date']; 
...
$objPHPExcel->getProperties()
			->setTitle(u8("Отчет о эффективности рекламы"))
			->setSubject(u8("Отчет о эффективности рекламы"))
			->setDescription(u8("Отчет о эффективности рекламы"))
			->setKeywords(u8("Отчет о эффективности рекламы"))
			->setCategory(u8("Отчет о эффективности рекламы"));
