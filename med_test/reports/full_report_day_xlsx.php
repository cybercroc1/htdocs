...
header("Content-Disposition: attachment; filename=\"rep-".$rep_date.".xls\"");
...
and date_call between to_date('$rep_date','DD.MM.YYYY') and to_date('$rep_date','DD.MM.YYYY')+1
-----------------------------------------------------------------"
.($_SESSION['user_role']==1?"":"and (
b.source_auto_id,
b.source_man_id,
b.source_type_id,
b.service_id
...
foreach($source_auto as $sup_id=>$supl){
    ...
    echo "<table border=1>";
    echo "<tr><th>Источник рекламы</th><th>Всего обращений</th><th>Принятых</th><th>В работе</th></tr>";
    $vse = 0;
    $order_count= 0;
    $inwork = 0;
