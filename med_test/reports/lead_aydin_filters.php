...
$report_id=11; //$_SESSION['reports']['ID'];
...
echo "<select id='sel_source_type' name='sel_source_type' style='width:225px' 
    onchange='ifr_all.location=\"lead_aydin_filters.php?getdet=\"+this.value'>";
...
<tr><td>
<input type="submit" name="Export_xlsx" id="Export_xlsx" value="В эксель" class="xlsx_button" onclick="frm.action='lead_aydin_xlsx.php';frm.submit();"/>
</td></tr>
</table>
