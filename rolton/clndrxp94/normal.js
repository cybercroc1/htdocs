...
var gbShortYear=0;   // year format   true: 2-digits; false: 4-digits
...
// ---- Common Options ----
var gMonths=["ßíâ","Ôåâ","Ìàð","Àïð","Ìàé","Èþí","Èþë","Àâã","Ñåí","Îêò","Íîÿ","Äåê"];
...
var gEnd=[2009,12,31];	// calendar date range end at [Year,Month,Date]
...
var gsBottom="<A href='javascript:void(0)' class='BottomAnchor' onclick='if(this.blur)this.blur();if(!fSetDate(gToday[0],gToday[1],gToday[2]))alert(\"You cannot select today!\");return false;' onmouseover='return true;' >Ñåãîäíÿ : "+gMonths[gToday[1]-1]+" "+gToday[2]+", "+gToday[0]+"</A>";	// the content of the bottom section.
