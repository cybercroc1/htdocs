...
//!!!!!добавить замену перевода строки на запятую			
	$src_phone=str_replace(";",",",$src_phone); //заменяем точку с зап на запятую 
	$src_phone=str_replace("	",",",$src_phone); //заменяем табуляцию на зяпятую
...
//!!!!здесь добавить распиливание на телефон и добавочный по # или еще каким-нить символам

		$result_phone=conv($phone); //над каждым номером выполняем функцию конвертирования
...
//!!!в результат добавить отпиленный экстеншн $result_phones[$i]['ext']='';		
			$result_phones[$i]['err']='';
			$i++;
		}	
