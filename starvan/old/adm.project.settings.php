...
if(isset($frm_submit) and $frm_submit=='save') {
	...
	set	name=nvl('".$project_name."',name), status=nvl('".$set_status."',status), nedoz_count=".$nedoz_count.", nedoz_interval=".$nedoz_interval.", from_time='".$from_time."', to_time='".$to_time."', quote='".$quote."', perez_policy='".$perez_policy."', nedoz_chance='".$nedoz_chance."', last_activity=sysdate
	where id=".$project_id);
