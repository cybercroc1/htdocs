...
function fCancelLoad(load_id,abort_pwd) {
	//alert('adm.loads.cancel_load.php?load_id='+load_id+'&abort_pwd='+abort_pwd);
	document.all.hidden_frame.src='adm.loads.cancel_load.php?load_id='+load_id+'&abort_pwd='+abort_pwd;
