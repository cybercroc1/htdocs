...
//пользователи
echo "пользователи: ";
$q=OCIParse($c,"select u.login,u.fio,u.coment,u.send,u.look,u.solution,u.redirect,u.eval,u.admin,u.send,u.sms_new,null all_grp, u.oper, u.create_new
from SUP_USER_LT_ALLOC sla, SUP_USER u
where sla.lt_group_id='".$lt_grp_id."' 
