...
if ($_SESSION['look']<>'' or $_SESSION['solution']<>'' or $_SESSION['redirect']<>'' or $_SESSION['eval']<>'' or  $_SESSION['create_new']<>'') {}
...
$q_text="select distinct b.id,
  ...
  from sup_base b, sup_klinika k, sup_user t, sup_trbl_type tt, sup_klinika_phones ph".$q_from."
