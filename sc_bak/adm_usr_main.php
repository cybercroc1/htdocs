...
if (isset($save) or isset($send)) {
	...
	$ins=OCIParse($c,"insert into sc_login (id,login,password,email,description,rep_period,fio,allow_records,allow_noreport,allow_record_full,allow_nocall)
	values ('".$new_login_id."','".$login."','".$password."','".$email."','".$description."','".$rep_period."','".$fio."','".$allow_records."','".$allow_noreport."',
	'".$allow_record_full."','".$allow_nocall."')");
	...
	allow_record_full='".$allow_record_full."', allow_nocall='".$allow_nocall."'
	where id='".$login_id."'");
