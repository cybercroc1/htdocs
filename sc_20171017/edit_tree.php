...
echo "<h4 style='color:#9900FF'>".$_SESSION['project_name'][$_SESSION['i']]."</h4>";
...
if ($punkt_id<>'') {
	...
	where p.project_id='".$_SESSION['project_id'][$_SESSION['i']]."' 
	...
	where t.id='".$tree_id."' and s.project_id='".$_SESSION['project_id'][$_SESSION['i']]."'
