...
if ($_SESSION['view_sms_log'][$_SESSION['i']]<>1) {echo "<font color=red>Страница недоступна!</font>"; exit();} 
?>
<?php
...
include("../../sc_conf/sc_conn_string");
	...
	echo "<nobr><font size=4> СМС-лог - \"".$_SESSION['project_name'][$_SESSION['i']]."\"</font> ";
...
where t.project_id='".$_SESSION['project_id'][$_SESSION['i']]."'
 ...
 <Styles>
  ...
  <Table ss:ExpandedColumnCount="7" x:FullColumns="1"
   ...
   <Row ss:AutoFitHeight="0">
    <Cell><ss:Data ss:Type="String" xmlns="http://www.w3.org/TR/REC-html40">СМС по проекту: "<B>'.$_SESSION['project_name'][$_SESSION['i']].'</B>" за период с <B>'.$_SESSION['start_bill_date'].'</B> по <B>'.$_SESSION['end_bill_date'].'</B> включительно</ss:Data></Cell>
   </Row>';
    ...
    <Cell><Data ss:Type="String">'.OCIResult($q,"ERROR_NUM").'</Data></Cell>
