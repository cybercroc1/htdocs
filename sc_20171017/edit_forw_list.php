...
from sc_forw_list t where t.id='".$list_id."'");
	...
	$q=OCIParse($c,"select * from sc_forw_list where project_id='".$_SESSION['project_id'][$_SESSION['i']]."' order by name");
	OCIExecute($q,OCI_DEFAULT);
	while (OCIFetch($q)) {
		echo "<option value=".OCIResult($q,"ID").">".OCIResult($q,"NAME")."</option>";
	}
...
function save_list($list_id,$name,$order_by,$fio_on,$doljnost_on,$email_on,$grafik_on,$coment_on,$otdel_on,$row_count,$head_text,$c) {
	...
	values ('".$new_list_id."','".$name."','".$order_by."','".$_SESSION['project_id'][$_SESSION['i']]."','".$fio_on."','".$doljnost_on."','".$email_on."','".$grafik_on."','".$coment_on."','".$otdel_on."','".$row_count."','".$head_text."')");
	...
	where id='".$list_id."' and project_id='".$_SESSION['project_id'][$_SESSION['i']]."'");
...
function del_list($list_id,$c) {
	$del=OCIParse($c,"delete from sc_forw_list where id='".$list_id."' and project_id='".$_SESSION['project_id'][$_SESSION['i']]."'");
...
function add_fio($list_id,$fio,$doljnost,$phone,$ext,$email,$grafik,$coment,$otdel,$c) {
	...
	$sel=OCIParse($c,"select nvl(max(ordering),0)+1 ordering from sc_forw_fio where list_id='".$list_id."' and project_id='".$_SESSION['project_id'][$_SESSION['i']]."'");
	OCIExecute($sel,OCI_DEFAULT);
	OCIFetch($sel);
	...
	values ('".$fio_id."','".$list_id."','".$fio."','".$doljnost."','".$ordering."','".$_SESSION['project_id'][$_SESSION['i']]."','".$grafik."','".$email."','".$coment."','".$otdel."')");
	OCIExecute($ins,OCI_DEFAULT);
		...
		'".$ext."',
		'".$phone."',
		'1','".$_SESSION['project_id'][$_SESSION['i']]."')"); 
...
function del_fio($fio_id,$c) {
	$del=OCIParse($c,"delete from sc_forw_fio where id='".$fio_id."' and project_id='".$_SESSION['project_id'][$_SESSION['i']]."'");
	OCIExecute($del,OCI_DEFAULT); 
	OCICommit($c);
}
//
...
function del_phone($phone_id,$c) {
	$del=OCIParse($c,"delete from sc_forw_phone where id='".$phone_id."' and project_id='".$_SESSION['project_id'][$_SESSION['i']]."'");
	OCIExecute($del,OCI_DEFAULT); 
	OCICommit($c);
}
//
...
where fio_id='".$fio_id."' and ordering>'".$ordering."' and project_id='".$_SESSION['project_id'][$_SESSION['i']]."'");
...
'".$ext."',
'".$phone."',
'".($ordering+1)."','".$_SESSION['project_id'][$_SESSION['i']]."')");
OCIExecute($ins,OCI_DEFAULT);
OCICommit($c);
}
//
...
where list_id='".$list_id."' and project_id='".$_SESSION['project_id'][$_SESSION['i']]."' and ordering<'".$ordering."'");
	OCIExecute($q,OCI_DEFAULT);
	OCIFetch($q);
	$perv_ordering=OCIResult($q,"PERV_ORDERING");
	$upd=OCIParse($c,"update sc_forw_fio set ordering='".$ordering."'
	where list_id='".$list_id."' and project_id='".$_SESSION['project_id'][$_SESSION['i']]."' and ordering='".$perv_ordering."'");
	OCIExecute($upd,OCI_DEFAULT);
	$upd2=OCIParse($c,"update sc_forw_fio set ordering='".$perv_ordering."' where project_id='".$_SESSION['project_id'][$_SESSION['i']]."' and id='".$fio_id."'");
...
where list_id='".$list_id."' and project_id='".$_SESSION['project_id'][$_SESSION['i']]."' and ordering>'".$ordering."'");
	OCIExecute($q,OCI_DEFAULT);
		...
		$upd=OCIParse($c,"update sc_forw_fio set ordering='".$ordering."'
		where list_id='".$list_id."' and project_id='".$_SESSION['project_id'][$_SESSION['i']]."' and ordering='".$next_ordering."'");
		OCIExecute($upd,OCI_DEFAULT);
		$upd2=OCIParse($c,"update sc_forw_fio set ordering='".$next_ordering."' where project_id='".$_SESSION['project_id'][$_SESSION['i']]."' and id='".$fio_id."'");
		OCIExecute($upd2,OCI_DEFAULT);
		OCICommit($c);
		}
	}
