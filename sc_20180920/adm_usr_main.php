...
if (isset($save) or isset($send)) {
	...
	$ins=OCIParse($c,"insert into sc_login (id,login,password,email,description,rep_period,fio,allow_records)
	values ('".$new_login_id."','".$login."','".$password."','".$email."','".$description."','".$rep_period."','".$fio."','".$allow_records."')");
	...
	$upd=OCIParse($c,"update sc_login set login='".$login."', password='".$password."', email='".$email."', description='".$description."', rep_period='".$rep_period."',fio='".$fio."',allow_records='".$allow_records."' where id='".$login_id."'");
