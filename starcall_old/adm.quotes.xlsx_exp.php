	...
	if(count($quoted_src_fields)>0) {
		...
		$i=0; foreach($quoted_src_fields as $field_id => $field_name) {$i++;
			if($i==1) {
				...
				decode(ssq.src_quote,0,null,null,null,round(ssq.src_norm/ssq.src_quote*100,2)) proc0,
				ssq.src_new new0,
				ssq.src_norm norm0, 
				ssq.inwork inwork0,
				ssq.end_error end_error0,
				ssq.end_false end_false0,
				ssq.end_nedoz end_nedoz0,
				ssq.end_otkaz end_otkaz0,
				ssq.end_quote end_quote0,
				ssq.nedoz nedoz0,
				ssq.perez perez0				
