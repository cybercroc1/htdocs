...
order by ord");
	...
	if(count($add_idx_fields)>0 or count($add_quoted_fields)>0) {
		$q_add_idx=OCIParse($c,"insert into STC_SRC_INDEXES i (id, project_id, field_id, Value, src_idx_new, src_idx_norm,i.inwork,i.end_error,i.end_false,
i.end_nedoz,i.end_otkaz,i.end_quote,i.nedoz,i.perez)
