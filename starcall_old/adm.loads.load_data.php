...
echo "</div></td></tr><tr><td class=footer_td>";	
	...
	echo "<input type='button' name=load value=Загрузить onClick='start_load()'>  <input type='button' name='cancel_load' style='display:none' value='Отменить' onClick=fCancelLoad()><br>";
