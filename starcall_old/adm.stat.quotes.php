...
if($level=='src') {
	...
	$i=0; while(OCIFetch($q)) {$i++;
		...
		echo "<td>".OCIResult($q,"INWORK")."</td>";
		echo "<td>".OCIResult($q,"END_ERROR")."</td>";
		echo "<td>".OCIResult($q,"END_FALSE")."</td>";
		echo "<td>".OCIResult($q,"END_NEDOZ")."</td>";
		echo "<td>".OCIResult($q,"END_OTKAZ")."</td>";
		echo "<td>".OCIResult($q,"END_QUOTE")."</td>";
		echo "<td>".OCIResult($q,"NEDOZ")."</td>";
		echo "<td>".OCIResult($q,"PEREZ")."</td>";
		echo "</tr>";	
	}
