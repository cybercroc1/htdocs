...
include("sc/func_code_phone.php");
...
$and_form_ids='';
$and_cdns='';
if($admin<>'y' and $_SESSION['allow_view_all_reports']<>1) {
...
if($admin=='y' or $_SESSION['allow_view_all_reports']==1) {
	//все строки
	$and_project_id="
		--без отчета
		and ((r.id is null 
...
if (isset($html_go)) {
	...
	$td_head="<th>";
	$end_td_head="</th>";
	$td_date="<td bgcolor=white style='cursor:pointer' onmouseover='sel_cell(this)' onmouseout='unsel_cell(this)'";
	$td_text="<td bgcolor=white style='cursor:pointer' onmouseover='sel_cell(this)' onmouseout='unsel_cell(this)'";
	$td_common="<td bgcolor=white style='cursor:pointer' onmouseover='sel_cell(this)' onmouseout='unsel_cell(this)'";
	$td_record="<td bgcolor=white onmouseover='sel_cell(this)' onmouseout='unsel_cell(this)'";
	$end_td="</td>";
	$end_tr="</tr>";
	$end_table="</table>";
}
...
if (isset($count_go)) {
	...
	echo "<input type=button name=count_go_go value=\"Показать отчет\" onclick=form2div('frm','count_filter_div',this,'report2.php')><hr>";
