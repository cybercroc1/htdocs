...
from sc_forw_fio t
	where t.id='".$fio_id."' and t.project_id='".$_SESSION['project']['id']."' ");
...
//
	...
	$q=OCIParse($c,"select * from sc_forw_phone where fio_id='".$fio_id."' and project_id='".$_SESSION['project']['id']."' order by ordering");
	OCIExecute($q,OCI_DEFAULT);
	echo "<tr>";
	while (OCIFetch($q)) {
...
$qqq.="where id='".$fio_id."' and project_id='".$_SESSION['project']['id']."'";
$upd=OCIParse($c,$qqq);
...
function del_phone($fio_id,$phone_id,$c) {
	...
	where project_id='".$_SESSION['project']['id']."' and fio_id='".$fio_id."' and id='".$phone_id."'");
