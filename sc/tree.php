...
$ins2=OCIParse($c,"insert into sc_punkt_tree (id,parent_id,punkt_id,lvl,end_node,shedule_id,name,link,link_type,link_target) values ((select nvl(max(id)+1,1) from sc_punkt),'".$parent_id."','".$punkt_id."','".($parent_lvl+1)."','1','".$shedule_id."','".$tree_name."',:link,'href','sc_fr2')");
