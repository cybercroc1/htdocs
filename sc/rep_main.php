...
if (isset($period_go)) {
	...
	echo "<table>";
	echo "<tr><td align=right valign=top>c:</td><td nowrap><b>".substr($_SESSION['start_rep_date'],0,10)."</b></td></tr>"; 

	echo "<tr><td align=right valign=top>по:</td><td nowrap><b>".substr($_SESSION['end_rep_date'],0,10)." (включительно)</b></td></tr>"; 
...
?>
<iframe width=174 height=189 name="gToday:normal:agenda.js?0002" id="gToday:normal:agenda.js?0002" src="clndrxp94/ipopeng.htm?0002" scrolling="no" frameborder="0" style="visibility:visible; z-index:999; position:absolute; top:-500px; left:-500px;">
</iframe>
</body>
</html>