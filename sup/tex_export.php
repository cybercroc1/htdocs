    ...
    '<B>'||to_char(trunc((nvl(b.in_work,nvl(b.date_close,sysdate))-b.date_in_call)))||'</B>д. <B>'||
     to_char(trunc(((nvl(b.in_work,nvl(b.date_close,sysdate))-b.date_in_call)-trunc((nvl(b.in_work,nvl(b.date_close,sysdate))-b.date_in_call)))*24))||'</B>ч.' dur_wrk_days,
	   round((nvl(b.in_work,nvl(b.date_close,sysdate))-b.date_in_call)*24,2) dur_wrk_hrs,	   
		 ...
		 b.quality,
		 b.trudozatrati_ispolnitel,
		 b.trudozatrati_zakazchik,
       case
...
<Workbook xmlns="urn:schemas-microsoft-com:office:spreadsheet"
 ...
 <Worksheet ss:Name="Лист1">
  <Names>
   <NamedRange ss:Name="_FilterDatabase" ss:RefersTo="=Лист1!R2C1:R2C14"
    ss:Hidden="1"/>
  </Names>
...
echo '<Row ss:AutoFitHeight="1" ss:Height="30">
    ...
    <Cell ss:StyleID="s63"><Data ss:Type="String">Дата поступления</Data><NamedCell
      ss:Name="_FilterDatabase"/></Cell>
    ...
    <Cell ss:StyleID="s63"><Data ss:Type="String">Кто обратился</Data><NamedCell
      ss:Name="_FilterDatabase"/></Cell>
    <Cell ss:StyleID="s63"><Data ss:Type="String">У кого не работает</Data><NamedCell
      ss:Name="_FilterDatabase"/></Cell>	  
    ...
    <Cell ss:StyleID="s63"><Data ss:Type="String">Оцен ка</Data><NamedCell
      ss:Name="_FilterDatabase"/></Cell>
    <Cell ss:StyleID="s63"><Data ss:Type="String">Трудозатраты исполнителя(час)</Data><NamedCell
      ss:Name="_FilterDatabase"/></Cell>	  
    <Cell ss:StyleID="s63"><Data ss:Type="String">Трудозатраты одобрено(час)</Data><NamedCell
      ss:Name="_FilterDatabase"/></Cell>
  </Row>
   ';
...
$rownum++;
	...
	echo '<Cell ss:StyleID="s65"><Data ss:Type="'.(OCIResult($q,"DATE_CLOSE")==''?'String':'DateTime').'">'.OCIResult($q,"DATE_CLOSE").'</Data></Cell>';
	...
	echo '<Cell ss:StyleID="s66"><Data ss:Type="String">'.OCIResult($q,"U_KOGO").'</Data></Cell>';
	...
	echo '<Cell ss:StyleID="s66"><Data ss:Type="Number">'.str_replace(',','.',OCIResult($q,"TRUDOZATRATI_ISPOLNITEL")/60).'</Data></Cell>';
	echo '<Cell ss:StyleID="s66"><Data ss:Type="Number">'.str_replace(',','.',OCIResult($q,"TRUDOZATRATI_ZAKAZCHIK")/60).'</Data></Cell>';
	echo '</Row>
   ';
}
...
echo '</Table>
  ...
  <AutoFilter x:Range="R2C1:R2C17" xmlns="urn:schemas-microsoft-com:office:excel">
  </AutoFilter>
 </Worksheet>
</Workbook>';
