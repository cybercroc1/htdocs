...
$secret = 'iaxnwlkjcs3lkezs';//'fwd5cueh8xux9s8c4kok0scosso0@i-sleep.bitrix24.ru'; //секрет вебхука в битриксе
...
echo "<br>ИНФОРМАЦИЯ о счетах:<br>";
$query = $btx24->query("
SELECT TOP(1) ID 
