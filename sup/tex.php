...
max(a.look) look, max(a.solution) solution, max(a.redirect) redirect, max(a.eval) eval, max(a.trudozatrati) trudozatrati, max(a.deny_close) deny_close, max(a.create_new) create_new, max(a.rep_stat) rep_stat
...
group by u.id, u.fio, u.coment, u.admin, u.registrar");
	OCIExecute($q,OCI_DEFAULT);
		if (OCIFetch($q)) {
			...
			$_SESSION['max_trudozatrati']=OCIResult($q,"TRUDOZATRATI");
...
if($_SESSION['admin']=='y' or $_SESSION['registrar']=='y') echo "<a href=adm.main.frame.php>админ</a> | "; 
